...
public class CervejaParametroDto
{
   ...
   [Range(typeof(decimal), "0.01", "99999.99", ErrorMessage = "A temperatura mínima deve ser maior que zero.")]
   public decimal CervejaParametroTemperaturaMin { get; set; }

   [Range(typeof(decimal), "0.01", "99999.99", ErrorMessage = "A temperatura máxima deve ser maior que zero.")]
   public decimal CervejaParametroTemperaturaMax { get; set; }

   [Range(typeof(decimal), "0.001", "99999.999", ErrorMessage = "O pH mínimo deve ser maior que zero.")]
   public decimal CervejaParametroPhMin { get; set; }

   [Range(typeof(decimal), "0.001", "99999.999", ErrorMessage = "O pH máximo deve ser maior que zero.")]
   public decimal CervejaParametroPhMax { get; set; }

   [Range(typeof(decimal), "0.01", "99999.99", ErrorMessage = "O extrato mínimo deve ser maior que zero.")]
   public decimal CervejaParametroExtratoMin { get; set; }

   [Range(typeof(decimal), "0.01", "99999.99", ErrorMessage = "O extrato máximo deve ser maior que zero.")]
